...
Block elements force a line break while inline does not,
Inline elements can only take LEFT and RIGHT padding/margin but CANNOT take height, while block level elements can accept all of them.
...
Git is valuable because it allows you to share and compare code globaly.
